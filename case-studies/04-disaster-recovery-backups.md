...
> **Context** Internal IT infrastructure — the company's business logic lives in Make.com scenarios
...
```mermaid
flowchart LR
    CRON["Monthly trigger<br/>(1st of month)"] --> FLOW["Backup scenario"]
...
- This is the most broadly reusable build of the 18 — a generic open-source version (`make-scenario-backup`) is planned.
