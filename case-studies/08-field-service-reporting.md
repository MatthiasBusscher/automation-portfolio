...
- **Hardcoded recipients, deliberately.** The one place where flexibility was *removed*: field users cannot change who receives the report. Misdirected reports were a real incident class; eliminating the input eliminates the incident.
