...
flowchart LR
    subgraph Ingest
    CRON["Scheduled trigger"] --> PROC["processOtherPost:<br/>scan entity + tax folders"]
...
- Incoming documents appear in the right logbook within a short interval, with correct file links and entity attribution — zero manual entry.
