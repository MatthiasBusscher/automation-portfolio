...
|---|-----------|-------|-----------------|
| <a id="case-01"></a>01 | [Recurring Revenue Metrics Engine (ARR/MRR/NRR)](case-studies/01-saas-metrics-engine.md) | GAS, Sheets | Monthly KPI reporting reduced from hours of manual work to zero |
